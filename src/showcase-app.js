...
import ParallelCoordinatesShowcase from './showcase-sections/parallel-coordinates-showcase';
...
import HistoryExample from './examples/history/history-example';
import ZoomableChart from './examples/zoomable-chart/zoomable-chart-example';
import DragableChart from './examples/dragable-chart/dragable-chart-example';
...
class App extends Component {
  render() {
    ...
    const linkedSection = window.location.href.split('/#')[1];
